...
class ARCHModelForecast(object):
    ...
    def __init__(
        ...
        self._sim_variances = [ _align_forecast( sim_variance , align=align) for sim_variance in simulated_variances ]
    ...
    @property
    def sim_variances(self) -> [DataFrame]:
        return self._sim_variances
